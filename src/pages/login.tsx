...
const Login = () => {
  ...
  return (
    <div className="flex bg-loginBg bg-no-repeat bg-center lg:bg-right lg:bg-contain bg-cover h-full">
      ...
      <div className="lg:flex-1 flex flex-col justify-center items-center h-screen w-full z-10">
